...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     tFarenheit = 259,
     tHora = 260,
     tValorTemperatura = 261
   };
#endif
/* Tokens.  */
#define tCentigrados 258
#define tFarenheit 259
#define tHora 260
#define tValorTemperatura 261
...
{
  "$end", "error", "$undefined", "tCentigrados", "tFarenheit", "tHora",
  "tValorTemperatura", "$accept", "S", "LISTA_TEMPERATURAS", "MEDICION",
  "TEMPERATURA", 0
};
#endif
